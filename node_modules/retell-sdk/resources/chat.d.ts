...
export declare class Chat extends APIResource {
     ...
     * ```
     */
    update(chatId: string, body: ChatUpdateParams, options?: Core.RequestOptions): Core.APIPromise<ChatResponse>;
    /**
     * List all chats
     *
     * @example
...
export declare namespace Chat {
    export { type ChatResponse as ChatResponse, type ChatListResponse as ChatListResponse, type ChatCreateChatCompletionResponse as ChatCreateChatCompletionResponse, type ChatCreateParams as ChatCreateParams, type ChatUpdateParams as ChatUpdateParams, type ChatCreateChatCompletionParams as ChatCreateChatCompletionParams, type ChatCreateSMSChatParams as ChatCreateSMSChatParams, };
}
